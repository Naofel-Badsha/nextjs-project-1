    ...
    <div className="bg-gray-100 dark:bg-gray-700 p-10 rounded-lg relative">
      ...
      <div className="mt-12">
        <div className="flex items-center mb-6 space-x-2">
          <BiCheck className="w-7 h-7 text-gray-950" />
      ...
      <div className="mt-8 text-center">
        <button
          className="w-full py-3 bg-blue-900/15 dark:bg-gray-100 text-blue-700 rounded-full hover:bg-blue-700 hover:text-white transition-all duration-300 cursor-pointer"
        >
          View Profile I
        </button>
      </div>

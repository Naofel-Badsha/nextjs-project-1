...
const JobCard = ({ job }: Props) => {
  return (
    <div className="border-[1.5px] border-gray-300 dark:border-gray-700 p-6 rounded-lg relative">
      <div
        className="w-7 h-7 cursor-pointer hover:bg-gray-300 dark:hover:bg-gray-800 flex items-center 
      transition-all duration-200 justify-center rounded-full flex-col absolute top-4 right-4"
      >
        ...
        <div>
          ...
          <div className="flex items-center space-x-6">
            <div className="flex items-center space-x-1 mt-2 text-gray-500">
              ...
              <p className="text-gray-500 text-sm">Sagment</p>
            </div>
            <div className="flex items-center space-x-1 mt-2 text-gray-500">
